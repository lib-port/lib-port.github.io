...
- refresh checked-in blog data: [`scripts/fetch_external_posts.py`](./scripts/fetch_external_posts.py) then commit [`_data/external_posts.json`](./_data/external_posts.json)
